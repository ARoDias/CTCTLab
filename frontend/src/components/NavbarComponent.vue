<template>
  ...
  <nav class="navbar navbar-expand-lg">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <template v-if="userAuthenticated">
            ...
            <li class="nav-item">
              <router-link to="/tp-classes" class="nav-link fs-6">Aulas TP</router-link>
            </li>
          </template>
        </ul>
      </div>
      ...
      <div>
        <a v-if="!userAuthenticated" href="#" @click="navigateToRegister">REGISTAR</a>
        ...
        <RegisterModal v-if="showModal && currentModalType === 'register'" @closeModal="closeModal"></RegisterModal>
        <LoginModal v-if="showModal && currentModalType === 'login'" @closeModal="closeModal"></LoginModal>
      </div>
    </div>
  </nav>
</template>
