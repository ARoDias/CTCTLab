                ...
                <form method="POST" @submit.prevent="submitRegister" class="form-group">
                    ...
                    <div class="field-group">
                        <div class="formfield">
                            ...
                            <input type="password" id="password1" v-model="password1" pattern=".{8,}"
                                title="Deve conter pelo menos 8 caracteres" required autocomplete="asdasdasd">
                        </div>
                        <div class="formfield">
                            <label for="password2">Confirmação da senha:</label>
                            <input type="password" id="password2" v-model="password2" pattern=".{8,}"
                                title="Deve conter pelo menos 8 caracteres" required autocomplete="asdasdasd">
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col">
                            <input type="text" class="form-control" placeholder="Primeiro Nome" aria-label="First name"
                                id="first_name" v-model="first_name" required autocomplete="given-name">
                        </div>
                        <div class="col">
                            <input type="text" class="form-control" placeholder="Apelido" aria-label="Last name"
                                id="last_name" v-model="last_name" required autocomplete="family-name">
                        </div>
                    </div>
                    ...
                    <div class="field-group">
                        <div class="formfield">
                            ...
                            <select id="course" v-model="course" required>
                                ...
                                <option v-for="course in courses" :key="course.id" :value="course.name">{{ course.name }}
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="field-group">
                            ...
                            <input type="radio" id="feminino" name="gender" value="F" v-model="gender">
                            <label for="feminino">Feminino</label><br>
                            <input type="radio" id="masculino" name="gender" value="M" v-model="gender">
                            <label for="masculino">Masculino</label><br>
                            <input type="radio" id="outro" name="gender" value="O" v-model="gender">
                    ...
                    <div text-align="left" class="consent-field">
                        <label for="data_consent">
                            <input type="checkbox" id="data_consent" v-model="data_consent" required>
                            Concordo com a <a href="#" @click.prevent="openPrivacyPolicy">recolha de dados</a>
                        </label>
                    </div>
        ...
        async submitRegister() {
            ...
            try {
                await axios.post('/api/register/', payload, {
                    ...
                    this.closeModal();
                    this.$router.push('/week/:weekNumber');
                })
